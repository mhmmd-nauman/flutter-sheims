...
class TableScreenTue extends StatelessWidget {
  
  const TableScreenTue({Key? key}) : super(key: key);
  static String routeName = 'TableScreenThu';
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TableDetailRow(
                                    title: 'Teacher-Name',
                                    statusValue: timetableTue[index].teacherName,
                                  ),
                                  kHalfSizedBox,
                                  TableDetailRow(
                                    title: 'Class-Room',
                                    statusValue:timetableTue[index].classRoom,
                                  ),
                                  kHalfSizedBox,
                                  TableDetailRow(
                                    title: 'Class-Time',
                                    statusValue:timetableTue[index].classTime,
                                  ),
                                  kHalfSizedBox,
