...
class AssignedTask extends StatelessWidget {
  ...
  static String routeName = 'AssignedTask ';
          ...
          child: ElevatedButton(
            onPressed: () {
              Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                return const PorgramOffered();
              }));
            },
            child: const Text("Courses for Software Engineering"),
          ),
        ),
      ),
    );
...
class PorgramOffered extends StatelessWidget {
  const PorgramOffered({super.key});
